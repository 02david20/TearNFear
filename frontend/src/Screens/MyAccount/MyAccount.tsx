...
export const MyAccount = (props: MyAccountProps) => {
  ...
  const isLogin = useAppSelector((state) => state.home.isLogin);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.stretch}>
        ...
        <View style={styles.centered}>
          <Text style={[styles.username, styles.centered]}>
            {" "}
            Báo Thủ Đại Vinh
          </Text>
        </View>
      ...
      <View style={styles.form}>
        <View style={styles.rowTable}>
          ...
          {isLogin ? (
            <Text style={styles.col2}>Báo Thủ Đại Vinh</Text>
          ) : (
        ...
        <View style={styles.rowTable}>
          ...
          {isLogin ? (
            <Text style={styles.col2}>Huỳnh Đại Vinh</Text>
          ) : (
            <Text style={styles.col2}>{i18n.t(LocalizationKey.NULL)}</Text>
          )}
        </View>
        <View style={styles.rowTable}>
          ...
          {isLogin ? (
            <Text style={styles.col2}>21</Text>
          ) : (
            <Text style={styles.col2}>{i18n.t(LocalizationKey.NULL)}</Text>
          )}
        </View>
        <View style={styles.rowTable}>
          ...
          {isLogin ? (
            <Text style={styles.col2}>
              235 Nguyễn Văn Cừ, phường 4, Quận 5, Thành phố Hồ Chí Minh
            </Text>
          ) : (
            <Text style={styles.col2}>{i18n.t(LocalizationKey.NULL)}</Text>
          )}
        ...
        <View style={styles.rowTable}>
          ...
          {isLogin ? (
            <Text style={styles.col2}>huynhvinhdavid@gmail.com</Text>
          ) : (
            <Text style={styles.col2}>{i18n.t(LocalizationKey.NULL)}</Text>
          )}
        </View>
